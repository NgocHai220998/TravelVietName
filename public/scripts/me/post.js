...
document.addEventListener("DOMContentLoaded",function(){
    ...
    {
        let containerSlide = document.querySelector('.container__slide .container__slide__content');
        let listImage = document.querySelectorAll('.container__slide__content .container__slide__content__image');
